...
| --- | --- | --- |
| Hugging Face large language model (LLM) and vision language model (VLM) training | `pip install nemo-automodel` | [AutoModel](https://docs.nvidia.com/nemo-oss/automodel/latest/) |
| Alignment (DPO, GRPO, SFT) | NeMo RL repo | [NeMo RL](https://docs.nvidia.com/nemo-oss/rl/latest/) |
| Speech ASR/TTS | `pip install nemo_toolkit[asr,tts]` | [NeMo Speech](https://docs.nvidia.com/nemo-oss/speech/nightly/) |
| Data curation | Curator repo | [Curator](https://docs.nvidia.com/nemo-oss/curator/latest/) |
