...
| --- | --- | --- |
| GRPO, DPO, SFT | [NeMo RL examples](https://docs.nvidia.com/nemo-oss/rl/latest/) | NeMo RL |
| RL environments | [NeMo Gym](https://docs.nvidia.com/nemo-oss/gym/latest/index.html) | Gym |
