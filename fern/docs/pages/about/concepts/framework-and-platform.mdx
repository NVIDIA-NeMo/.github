...
Most NeMo Open Source Software users start from one of two paths: **NeMo Framework** for model lifecycle work, or **NeMo Platform** for integrated agent workflows. They share libraries, but they answer different developer questions.
...
| Name | Meaning |
| --- | --- |
| **NeMo Open Source Software** | The GitHub organization, documentation, and related open source containers. |
...
See how NeMo Open Source Software, Platform, and the broader NVIDIA NeMo suite relate.
</Card>
