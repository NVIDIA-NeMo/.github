...
| **Docs** | NeMo OSS pages and library docs | [NeMo Platform docs](https://nvidia-nemo.github.io/nemo-platform/main/) |
...
| Open source docs on docs.nvidia.com/nemo-oss | Microservice docs under `docs.nvidia.com/nemo-oss/microservices` |
...
Speech workloads often start with [NeMo Speech](https://docs.nvidia.com/nemo-oss/speech/nightly/) directly — the [NeMo](https://github.com/NVIDIA-NeMo/NeMo) repo is speech-only today.
