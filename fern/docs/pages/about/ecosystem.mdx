---
title: Ecosystem
subtitle: NeMo Open Source Software Within the NVIDIA NeMo Software Suite
slug: about/ecosystem
position: 2
---

**NeMo Open Source Software** is the public entry point for [NVIDIA NeMo](https://www.nvidia.com/en-us/ai-data-science/products/nemo/): the [NVIDIA-NeMo](https://github.com/NVIDIA-NeMo) GitHub organization, and the libraries and containers that support model and agent development.

<Callout intent="info">
This page explains **where NeMo Open Source Software fits** and **what to choose**. For the organizing model, refer to [Concepts](/about/concepts). For structure, refer to [Architecture](/about/architecture).
</Callout>

## What You Can Build

NeMo Open Source Software is organized around two adoption paths:

```mermaid
flowchart TB
    subgraph nemooss ["NeMo Open Source Software"]
...
| **Docs** | NeMo Open Source Software pages and library docs | [NeMo Platform setup](https://nvidia-nemo.github.io/nemo-platform/main/get-started/setup/) |
...
NeMo Open Source Software focuses on open source repositories, documentation, and Framework container releases. The broader NVIDIA NeMo suite also includes commercial products, enterprise services, and NIM microservices with their own product documentation.

| NeMo Open Source Software | Broader NVIDIA NeMo Docs |
| --- | --- |
...
| **Scope** | Orientation across NeMo Open Source Software | One library or Platform at a time |
...
How NeMo Open Source Software organizes stacks, stages, libraries, and docs.
</Card>
