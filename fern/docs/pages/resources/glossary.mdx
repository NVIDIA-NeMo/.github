---
title: Glossary
subtitle: Terms Used Across NeMo Open Source Software Documentation
slug: resources/glossary
---

Use this glossary for quick lookup of NeMo Open Source Software terminology. For relationship-level explanations, use [Concepts](/about/concepts).
...
Container
: An NGC image that packages a tested runtime. NeMo Open Source Software uses both the multi-library Framework container and standalone containers for selected libraries.
...
: The public open source side of NVIDIA NeMo: the [NVIDIA-NeMo](https://github.com/NVIDIA-NeMo) GitHub organization, documentation, and related open source containers.
...
RL
: Reinforcement learning. In NeMo Open Source Software, the RL stage includes post-training workflows such as SFT, DPO, GRPO, distillation, and agent improvement.
