...
|[Previous NeMo (with Lightning)->will repurpose to focus on Speech](https://github.com/NVIDIA/NeMo)|Pretraining,SFT|PyTorch Lightning Loop|PyTorch?|RIVA?|Speech|
