...
|[NeMo Safe Synthesizer](https://github.com/NVIDIA-NeMo/Safe-Synthesizer)|[Privacy-preserving synthetic tabular data](https://nvidia-nemo.github.io/Safe-Synthesizer/)|HF Trainer|PyTorch, Opacus|vLLM|LLM|NA|
|[NeMo Anonymizer](https://github.com/NVIDIA-NeMo/Anonymizer)|[PII detection and anonymization](https://nvidia-nemo.github.io/Anonymizer/)|NA|NA|NA|Agnostic|NA|
